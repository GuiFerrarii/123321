                    ...
                    <form action=".././funcoes_calendario/save_curso.php" method="post">
                        <div class="user__details">
                            ...
                            <div class="input__box">
                                ...
                                <input type="text" placeholder="Ex: Diurno" name="turno" id="turno" required>
                            </div>
                            ...
                            <div class="input__box">
                                ...
                                <input type="text" placeholder="1200" name="cargahoraria" id="cargahoraria"
                                    required>
                            </div>
                ...
                <div class="form-add add-curso">
                    <form action=".././funcoes_calendario/save_uc.php" method="post">
                        <div class="user__details">
                            ...
                            <!-- aqui input novo -->
                            <div class="input__box">
                                <span class="details">Numero da UC:</span>
                                <input type="text" name="numUC" id="numUC" placeholder="Numero da UC"
                                    required>
                            </div>
                        </div>
